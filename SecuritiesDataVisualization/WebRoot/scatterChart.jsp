  ...
  <div style="margin:5px 10px 20px 30px;height:50px;" align="left">
	...
	<div class="dropdown">
		<select name="one" class="dropdown-select" id="report">
			<option value="2007">一季报</option>
			<option value="2008">半年报</option>
			<option value="2009">三季报</option>
			<option value="2010">年报</option>
...
function loaddata(){
  ...
  var boardcode = "5";
  var date = "2012/02/10";
  $.getJSON('displayBoardStocksData.action?boardcode='+boardcode+'&date='+date , function(result) {
	data = eval(result);
	var chart;
