...
<body >
  <div style="margin:5px 10px 20px 30px;height:50px;" align="left">
  	股票代码：
  	<input type="text" value="" id="stockcode" style="width:120px;height:24px;top:24%"></input>
  	&nbsp;&nbsp;时间段：
	<input type="text" value="1/31/2012-4/27/2013" id="rangeA" />
	指标一：
	<div class="dropdown">
		<select name="one" class="dropdown-select" id="indic1">
			<option value="close">close</option>
			<option value="volume">volume</option>
			<option value="open">open</option>
			<option value="lclose">lclose</option>
		</select>
	</div>

	&nbsp;&nbsp;指标二：
	<div class="dropdown">
		<select name="two" class="dropdown-select" id="indic2">
			<option value="close">close</option>
			<option value="volume">volume</option>
			<option value="open">open</option>
			<option value="lclose">lclose</option>
  	...
  	<button class="sexybutton sexyorange" onclick="test()"><span><span><span class="ok"> Submit</span></span></span></button>
...
function test(){
	/*var stockcode=$("#stockcode").eval();
	var indic1 = $("#indic1").eval();
	var indic2 = $("#indic2").eval();*/
	$("#chart1 svg").empty();
	var stockcode=$("#stockcode").attr("value");
	var indic1 = $("#indic1").val();
	var indic2 = $("#indic2").val();
	var rangdate = $("#rangeA").attr("value");

	$.getJSON('displayData.action?stockcode='+stockcode+'&indicator='+indic1+','+indic2+'&rangdate='+rangdate , function(result) {
